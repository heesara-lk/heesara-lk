export default function Refund() {
  return (
    <div className="max-w-3xl mx-auto p-8 prose">
      <h1>Return & Refund Policy - Heesara.lk</h1>
      <p>Since Heesara.lk provides digital service (profile access), there is no physical product return.</p>
      <h2>Refund</h2>
      ...
      <p>For issues: support@heesara.lk / +94 91 427 0377</p>
    </div>
  )
}